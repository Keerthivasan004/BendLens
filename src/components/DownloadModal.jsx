...
export default function DownloadModal({ isOpen, onClose, reason = 'DEFAULT' }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4 animate-fadeIn">
      <div className="glass-panel w-full max-w-2xl rounded-3xl border border-border shadow-2xl overflow-hidden flex flex-col">
        {/* Header */}
        ...
        {/* Modal Body */}
        <div className="p-6 space-y-5 bg-white dark:bg-black">
          {/* Brand & Privacy Card */}
          <div className="p-4 rounded-2xl bg-blue-50 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-800/80 flex items-start gap-3">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
              <div className="p-3.5 rounded-xl bg-surface-card border border-border">
