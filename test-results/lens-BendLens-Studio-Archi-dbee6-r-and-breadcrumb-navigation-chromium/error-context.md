...
- Name: lens.spec.js >> BendLens Studio & Architecture Lens (/lens) >> should render header controls, repository indicator, and breadcrumb navigation
- Location: tests\lens.spec.js:12:3
