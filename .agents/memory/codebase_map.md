...
- **`safeAdmZip.js`**: Centralized runtime loader for `adm-zip` using dynamic `eval('require')` to prevent Turbopack AST static module mangling/hashing into broken aliases in production standalone/Electron builds.
